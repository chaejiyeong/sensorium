...
f = open('/home/jy/Desktop/계량기&ltype1 지운 형식')  # train, test 둘 다
...
for i in range(100):
    ...
    svc = SVC()
    gsSVC = GridSearchCV(svc, params, scoring="f1_macro",
                         verbose=1, cv=3, refit=True)
    ...
    # parameter_array.append(gsSVC.best_params_)
    # estimator = gsSVC.best_estimator_
