    ...
    for data in data_list:
        ...
        for model in model_list:
            for seed in range(rand_seed):
                ...
                trainer.grid_search_CV(model, seed, params, folder_name, file_name , 0)
            trainer.save_result(folder_name, file_name, str(data))
...
def param_test(name, data_lst, model_lst, rand_seed, x_train, x_test, y_train, y_test):
    data_list = data_lst
    model_list = model_lst
    ...
    for data in data_list:
        ...
        for model in model_list:
            ...
            folder_name = name[0]
            file_name = str(data) + "_" + str(rand_seed)
            trainer.validation(model, rand_seed, params, folder_name, file_name, x_train, x_test, y_train, y_test)
