...
def pre_process(name):
    ...
    used = [['0', '0', '0'], ['0', '0', '2'], ['0', '1', '1'], ['0', '1', '0'], ['0', '3', '0'], ['0', '3', '1'], ['0', '3', '2'], ['0', '5', '2'], ['1', '6', '0'], ['1', '6', '2'], ['1', '7', '0'], ['1', '9', '2'], ['1', '10', '0']]
    # used = [['0', '3', '2']]
    leak_num = 0
    no_leak_num = 0
    for row in data:
    ...
    x_data = np.concatenate([freq_data, pipe_data], axis=1)
...
def pre_process_aug(name, rand_seed, aug):    
    x_name = "data/x_data_" + name + ".csv"
    y_name = "data/y_data_" + name + ".csv"
